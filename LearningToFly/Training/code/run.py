...
def train(num_timesteps, copter_model, model_directory, save_model_interval, 
        save_model_with_prefix, restore_model_from_file, play, 
        visualize):
    ...
    train_env = hybrid3D_env.Hybrid3DEnv(
            data_folder = "../data/", config_file = copter_model + ".xml", play = False)

    play_env = hybrid3D_env.Hybrid3DEnv(
            data_folder = "../data/", config_file = copter_model + ".xml", play = visualize or play)
    ...
    pposgd_simple.learn(train_env, play_env,  policy_fn,
            ...
            optim_epochs=50, 
            optim_stepsize=3e-4, 
            optim_batchsize=3000,
            # optim_batchsize=64, default
